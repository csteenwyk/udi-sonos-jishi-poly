...
# Program content display format for multi-param commands
PGM-CMD-SAY-FMT = /phrase// ${v}/ /vol// at ${v}%/
PGM-CMD-CLIP-FMT = /clip// ${v}/ /vol// at ${v}%/
PGM-CMD-SAY_ALL-FMT = /phrase// ${v}/ /vol// at ${v}%/
PGM-CMD-CLIP_ALL-FMT = /clip// ${v}/ /vol// at ${v}%/
